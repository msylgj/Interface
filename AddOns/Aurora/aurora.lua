...
Delay:SetScript("OnEvent", function()
	...
	if IsAddOnLoaded("aMail") then F.Reskin(aMailButton) end
	if IsAddOnLoaded("m_Loot") then F.ReskinArrow(m_LootAdv, "down") F.ReskinClose(m_LootClose) end
