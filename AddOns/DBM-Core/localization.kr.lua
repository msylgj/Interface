...
DBM_CORE_AUTO_ANNOUNCE_OPTIONS.count		= "$spell:%s 알림 보기(횟수 포함)"
...
DBM_CORE_AUTO_SPEC_WARN_TEXTS.moveto		= "%s - >%%s< 방향으로 이동!"
...
DBM_CORE_AUTO_SPEC_WARN_OPTIONS.switchcount 	= "$spell:%s 대상 전환 특수 경고 보기(횟수 포함)"
...
DBM_CORE_AUTO_TIMER_OPTIONS.cdspecial		= "특수 능력 대기시간 바 보기"
