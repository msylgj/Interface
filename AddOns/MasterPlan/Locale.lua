...
L == "esMX" and {
	...
	["Missions of Interest"] = "Misiones de interés ",
	["Mitigated threats"] = "Amenazas mitigadas",
	["Potential counters:"] = "Podría contrarrestar una de estas amenazas:",
	Ready = "Listo",
...
L == "koKR" and {
	...
	["An additional random ability is unlocked when this follower reaches epic quality."] = "추종자가 영웅 등급이 되었을 때 사용 가능합니다.",
	...
	["Mitigated threats"] = "상쇄된 위협 요소",
	["Potential counters:"] = "잠재 상쇄 능력:",
	Ready = "준비 완료",
...
L == "ruRU" and {
	...
	["An additional random ability is unlocked when this follower reaches epic quality."] = "Будет доступна, при достижение соратником эпического качества.",
	...
	["Future Mission #%d"] = "Будущая миссия #%d",
	...
	["Potential counters:"] = "Потенциальные счетчики:",
	Ready = "Готово",
	...
	["Using this item replaces a random trait."] = "Использование этого предмета заменит случайную особенность.",
	...
	["You have no followers who activate this trait."] = "У вас нет соратников,которые активируют эту особенность.",
...
L == "zhCN" and {
	...
	["An additional random ability is unlocked when this follower reaches epic quality."] = "当此追随者达到史诗品质时解锁。",
...
L == "zhTW" and {
	...
	["An additional random ability is unlocked when this follower reaches epic quality."] = "此技能將在追隨者達到史詩等級後解鎖",
