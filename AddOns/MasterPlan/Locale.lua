...
L == "esES" and {
	...
	["Complete All"] = "Completar todas", -- Needs review
	...
	["Unused followers:"] = "Seguidores sin usar:", -- Needs review
...
L == "esMX" and {
	...
	["Followers with this trait:"] = "Seguidores con este rasgo:",
	["Follower XP"] = "Experiencia de Seguidor",
	["Garrison resources"] = "Recursos de Fortaleza", -- Needs review
	["Group %d"] = "Grupo %d",
	Idle = "Desocupado",
	["Idle (max-level)"] = "Desocupado (nivel-max)",
	Ignore = "Ignorar",
	Ignored = "Ignorado",
	["In Tentative Party"] = "En grupo tentativo", -- Needs review
	["Last completed: %s ago"] = "Últimos completados: hace %s",
	["Mission duration"] = "Duración de la misión",
	["Mission expiration"] = "Expiración de la Misión",
	["Mission level"] = "Nivel de misión",
	...
	["Mitigated threats"] = "Amenazas mitigadas",
	Ready = "Listo",
	["Reward: %s XP"] = "Recompenza: %s EXP", -- Needs review
	["+%s experience expected"] = "+%s experiencia esperada",
	Success = "Éxito ",
	["Success chance"] = "Probabilidad de éxito",
	["Suggested groups"] = "Grupos Sugeridos",
	["%s XP"] = "%s EXP", -- Needs review
	["%s XP gained"] = "%s EXP ganada", -- Needs review
	["%s XP/h"] = "%s EXP/h", -- Needs review
	Unignore = "Quitar Ignorar",
	["Unused followers:"] = "Seguidores no utilizados", -- Needs review
	["View Rewards"] = "Mostrar Recompensas",
	["You have no followers to counter this mechanic."] = "No tienes ningún seguidor que contrarreste esta mecánica.",
	["You have no followers with this trait."] = "No tienes ningún seguidor con este rasgo,",
	["You have no free bag slots."] = "No tienes espacio en las mochilas.",
...
L == "frFR" and {
	...
	["Can be countered by:"] = "Contré par :", -- Needs review
	["Chance of success"] = "Chance de réussite", -- Needs review
	...
	["Last completed: %s ago"] = "Finie il y a %s", -- Needs review
	["Mission duration"] = "Durée de mission",
	["Mission expiration"] = "Expiration de mission", -- Needs review
	["Mission level"] = "Niveau de mission", -- Needs review
	["Mission order:"] = "Missions triées par :",
	["Missions of interest"] = "Missions intéressantes", -- Needs review
	["Mitigated threats"] = "Menaces contrées", -- Needs review
	Ready = "Prêt",
	...
	["Unused followers:"] = "Sujets non utilisés :", -- Needs review
...
L == "koKR" and {
	...
	["Follower experience per hour"] = "시간 당 추종자 경험치", -- Needs review
	...
	["Last completed: %s ago"] = "마지막 완료: %s 전", -- Needs review
	["Mission duration"] = "임무 완료 시간",
	["Mission expiration"] = "임무 만료 시간",
	["Mission level"] = "임무 레벨",
	["Mission order:"] = "임무 정렬:",
	["Missions of interest"] = "관심있는 임무", -- Needs review
...
L == "zhCN" and {
	...
	["%s XP/h"] = "%s 经验/时",
	Unignore = "取消忽略",
	["Unused followers:"] = "无用的追随者：", -- Needs review
	["View Rewards"] = "查看奖励",
