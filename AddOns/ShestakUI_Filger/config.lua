...
--[[		{
	...
	["PALADIN"] = {			--[Ê¥Æï]
		{
			...
			-- Shield of the righteous ÕýÒå¶Ü»÷
	...
	["ALL"] = {			--[¼¯Ìå]
		...
		},
		{
			...
			-- Other
			-- Rocket Fuel Leak »ð¼ýÐ¬Â©ÓÍ
			{spellID = 94794, unitID = "player", caster = "player", filter = "DEBUFF"},
		
			--  -- <<  PVE  >> -- --
			-- Throne of Thunder	-- À×µçÍõ×ù
			-- Jin'rokh the Breaker [»÷ËéÕß½ðÂÞ¿Ë]
			...
			-- Amber-Shaper Un'sok [çúçêËÜÐÎÕß°ºÊæ¿Ë]
			-- Burning Amber
			...
			-- terrace of endless spring -- ÓÀ´ºÌ¨
			-- Protector of the Endless [ÎÞ¾¡ÊØ»¤Õß]
			-- Lightning Prison ÉÁµçÀÎÁý
