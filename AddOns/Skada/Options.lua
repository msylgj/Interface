...
Skada.windowdefaults = {
	...
	title = {height = 20, font="Accidental Presidency", fontsize=13,margin=0, texture="Minimalist", bordertexture="None", borderthickness=2, color = {r=0.1,g=0.1,b=0.3,a=0}, fontflags = "OUTLINE"},
