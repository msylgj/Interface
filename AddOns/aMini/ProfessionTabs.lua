...
--[[
	...
	PROFESSION_RANKS = {
		...
		[4] = { 300, "Artisan" }, -- 专家级
		[5] = { 375, "Master" }, -- 大师级
		[6] = { 450, "Grand Master" }, -- 宗师级
		[7] = { 525, "Illustrious" }, -- 巨匠级
		[8] = { 600, "Zen Master" }, -- Mop禅师级
	}
...
local Professions = {
	[1] = { 2259, 3101, 3464, 11611, 28596, 51304, 80731, 105206 }, -- Alchemy炼金
	[2] = { 2018, 3100, 3538, 9785, 29844, 51300, 76666, 110396 }, -- Blacksmithing锻造
	[3] = { 7411, 7412, 7413, 13920, 28029, 51313, 74258, 110400 }, -- Enchanting附魔
	[4] = { 4036, 4037, 4038, 12656, 30350, 51306, 82774, 110403 }, -- Engineering工程
	[5] = { 45357, 45358, 45359, 45360, 45361, 45363, 86008, 110417 }, -- Inscription铭文
	[6] = { 25229, 25230, 28894, 28895, 28897, 51311, 73318, 110420 }, -- Jewelcrafting珠宝加工
	[7] = { 2108, 3104, 3811, 10662, 32549, 51302, 81199, 110423 }, -- Leatherworking制皮
	[8] = { 3908, 3909, 3910, 12180, 26790, 51309, 75156, 110426 }, -- Tailoring裁缝
	[9] = { 2550, 3102, 3413, 18260, 33359, 51296, 88053, 104381 }, -- Cooking烹饪
	[10] = { 3273, 3274, 7924, 10846, 27028, 45542, 74559, 110406 }, -- First Aid急救
	[11] = { 78670, 88961, 89718, 89719, 89720, 89721, 89722, 110393 }, -- Archaeology考古
	[12] = { 53428 }, -- Runeforging符文熔铸
	[13] = { 2656 }, -- Smelting熔炼
	[14] = { 13262 }, -- Disenchant分解
	[15] = { 51005 }, -- Milling研磨
	[16] = { 31252 }, -- Prospecting选矿
	[17] = { 818 }, -- Basic Campfire烹饪用火
	[18] = { 1804 }, -- Pick Lock开锁
	[19] = { 80451 }, -- Survey勘测_考古
}
...
function ProfessionTabs:CreateTab(Table, Parent)
	...
	Tab:SetPoint("TOPLEFT", Parent, "TOPRIGHT", Parent == ATSWFrame and -32 or 0, (Parent == TradeFrame and -32 or -24) + -44 * #Table)
