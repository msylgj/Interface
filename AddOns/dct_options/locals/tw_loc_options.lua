...
DCT_FONT_OPTION = "自定義字型";
DCT_SAVE_OPTION = "預設和配置檔"
DCT_MISC_OPTION = "其他設置"
DCT_SPEC_OPTION = "特定事件1"
DCT_SPEC_OPTION2 = "特定事件2"

DCT_BUTTON_RESET_LABEL = "恢復預設值";
DCT_BUTTON_RESET_TIP= "恢復預設值";
DCT_BUTTON_SAVECUSTOM_LABEL = "保存個人設定"
DCT_BUTTON_LOADCUSTOM_LABEL = "讀取個人設定"

DCT_EVENT_TIP1 = "點擊選擇輸出動畫框架，數字代表動畫框架的編號"
DCT_EVENT_TIP2 = "點擊編輯具體顯示文字及其他一些相關的詳細設定"

DCT_RESET_TIP = "已載入預設值";
...
DCT_OptionCfg_Event.EventFrames["DCT_SHOWHITCRIT"].title = "傷害(暴擊)"
DCT_OptionCfg_Event.EventFrames["DCT_SHOWHITCRIT"].tooltipText = "顯示你受到的暴擊傷害"
...
DCT_OptionCfg_Event.EventFrames["DCT_SHOWBUFF"].title = "增益效果獲得"
DCT_OptionCfg_Event.EventFrames["DCT_SHOWBUFF"].tooltipText = "顯示你獲得的增益效果"
DCT_OptionCfg_Event.EventFrames["DCT_SHOWBUFFFADE"].title = "增益效果消失"
DCT_OptionCfg_Event.EventFrames["DCT_SHOWBUFFFADE"].tooltipText = "顯示你消失的增益效果"	
DCT_OptionCfg_Event.EventFrames["DCT_SHOWBUFFDOSE"].title = "增益效果疊加"
DCT_OptionCfg_Event.EventFrames["DCT_SHOWBUFFDOSE"].tooltipText = "顯示你的增益效果疊加及減少"		
DCT_OptionCfg_Event.EventFrames["DCT_SHOWENVIRONMENTAL"].title = "環境傷害"
DCT_OptionCfg_Event.EventFrames["DCT_SHOWENVIRONMENTAL"].tooltipText = "例如溺水掉落等"
...
DCT_OptionCfg_Event.EventFrames["DCT_SHOWSHIELD"].title = "反彈傷害"
DCT_OptionCfg_Event.EventFrames["DCT_SHOWSHIELD"].tooltipText = "反彈傷害"
...
DCT_OptionCfg_Event.EventFrames["DCT_SHOWSPELLCRIT"].title = "技能傷害(暴擊)"
DCT_OptionCfg_Event.EventFrames["DCT_SHOWSPELLCRIT"].tooltipText = "顯示你受到的技能暴擊傷害"
...
DCT_OptionCfg_Event.EventFrames["DCT_SHOWPOWER"].tooltipText = "顯示獲得的能量，法力值等"
...
DCT_OptionCfg_Event.EventFrames["DCT_SHOWDEBUFF"].title = "減益效果獲得"
DCT_OptionCfg_Event.EventFrames["DCT_SHOWDEBUFF"].tooltipText = "顯示你獲得的減益效果"
DCT_OptionCfg_Event.EventFrames["DCT_SHOWDEBUFFFADE"].title = "減益效果消失"
DCT_OptionCfg_Event.EventFrames["DCT_SHOWDEBUFFFADE"].tooltipText = "顯示你消失的減益效果"
DCT_OptionCfg_Event.EventFrames["DCT_SHOWDEBUFFDOSE"].title = "減益效果疊加"
DCT_OptionCfg_Event.EventFrames["DCT_SHOWDEBUFFDOSE"].tooltipText = "顯示你的減益效果疊加及減少"
...
DCT_OptionCfg_Event.EventFrames["DCT_SHOWLOWMANA"].tooltipText = "法力值低於設定的百分比則顯示"
...
--options_ex ********************************************************************************************************************************
--******************************************************************************************************************************************
DCT_TEXT_OPEX_FONTENDDC = "英文字型:"
DCT_TEXT_OPEX_FONTCHDDC = "中文字型:"
DCT_TEXT_OPEX_FONTEFFDDC = "字型效果:"
...
DCT_Opex_MulitEditLabel["DCT_SHOWSPECBUFF"] = {"增益效果","減益效果"}
...
DCT_Opex_MulitEditLabel["DCT_SHOWSPECTARGETBUFF"] = {"目標","集中"}
DCT_Opex_MulitEditLabel["DCT_SHOWSPECTARGETDEBUFF"] = {"目標","集中"}
DCT_Opex_MulitEditLabel["DCT_SHOWSPECTARGETBUFFFADE"] = {"目標","集中"}
DCT_Opex_MulitEditLabel["DCT_SHOWSPECTARGETDEBUFFFADE"] = {"目標","集中"}

DCT_Opex_Config.Sliders["fSizeEn"].title = "數字大小修正"
DCT_Opex_Config.Sliders["fSizeCh"].title = "文字大小修正"
DCT_Opex_Config.Sliders["per"].title = "低傷害篩選"
...
DCT_Opani_Config.Sliders["fSizeEn"].title = "英文字型大小"
DCT_Opani_Config.Sliders["fSizeCh"].title = "中文字型大小"
...
DCT_AniModeParamsSliders[3].Sliders["param1"].title = "條數量"
DCT_AniModeParamsSliders[3].Sliders["param1"].tooltipText = "最大條數量"
...
--options_font ********************************************************************************************************************************
--******************************************************************************************************************************************
DCT_TEXT_OPFONT_EDIT = "編輯當前選中字型: (輸入完按ENTER確認)"
...
DCT_MiscCfg_Event.CheckButtons["DCT_SSC_Number"].title = "自動傷害數字著色"
DCT_MiscCfg_Event.CheckButtons["DCT_SSC_Number"].tooltipText = "自動將傷害數字(#am)根據法術類別著色,將會覆蓋事件設定顏色"
DCT_MiscCfg_Event.CheckButtons["DCT_SSC_SpellSchool"].title = "自動法術類別名著色"
DCT_MiscCfg_Event.CheckButtons["DCT_SSC_SpellSchool"].tooltipText = "自動將傷害類別字樣(#ss)根據法術類別著色,將會覆蓋事件設定顏色"
DCT_MiscCfg_Event.CheckButtons["DCT_SSC_Spell"].title = "自動技能名著色"
DCT_MiscCfg_Event.CheckButtons["DCT_SSC_Spell"].tooltipText = "自動將技能名(#sn)根據法術類別著色,將會覆蓋事件設定顏色"
...
DCT_SpecCfg_Event.EventFrames["DCT_SHOWSPECDEBUFFFADE"].title = "自己特定減益效果消失"
...
DCT_SpecCfg_Event2.EventFrames["DCT_SHOWSPECTARGETBUFF"].title = "目標/集中特定增益效果獲得"
DCT_SpecCfg_Event2.EventFrames["DCT_SHOWSPECTARGETDEBUFF"].title = "目標/集中特定減益效果獲得"
DCT_SpecCfg_Event2.EventFrames["DCT_SHOWSPECTARGETBUFFFADE"].title = "目標/集中特定增益效果消失"
DCT_SpecCfg_Event2.EventFrames["DCT_SHOWSPECTARGETDEBUFFFADE"].title = "目標/集中特定減益效果消失"
