...
local indicator = "Interface\\AddOns\\oUF_Qulight\\Root\\Media\\squares.ttf"
local symbols =  "Interface\\AddOns\\oUF_Qulight\\Root\\Media\\PIZZADUDEBULLETS.ttf"
...
local Enable = function(self)
    if(self.freebIndicators) then
        ...
        self.AuraStatusTL:SetFont(indicator, Qulight["raidframes"].indicatorsize, "THINOUTLINE")
        ...
        self.AuraStatusTR:SetFont(indicator, Qulight["raidframes"].indicatorsize, "THINOUTLINE")
        ...
        self.AuraStatusBL:SetFont(indicator, Qulight["raidframes"].indicatorsize, "THINOUTLINE")
        ...
        self.AuraStatusCen:SetFont(Qulight["media"].font, Qulight["raidframes"].fontsizeEdge, Qulight["raidframes"].outline)
        self.AuraStatusCen:SetShadowOffset(1.25, -1.25)
        self.AuraStatusCen:SetWidth(Qulight["raidframes"].width)
