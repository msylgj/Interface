...
-- Warrior
oUF.Tags.Methods['q:stragi'] = function(u) if not(UnitAura(u, GetSpellInfo(6673)) or UnitAura(u, GetSpellInfo(57330)) or UnitAura(u, GetSpellInfo(8076))) then return "|cffFF0000"..x.."|r" end end
oUF.Tags.Events['q:stragi'] = "UNIT_AURA"

oUF.Tags.Methods['q:vigil'] = function(u) if UnitAura(u, GetSpellInfo(50720)) then return "|cff8B4513"..x.."|r" end end
oUF.Tags.Events['q:vigil'] = "UNIT_AURA"
...
oUF.Tags.Methods['q:fmagic'] = function(u) if UnitAura(u, GetSpellInfo(54648)) then return "|cffCC00FF"..x.."|r" end end
oUF.Tags.Events['q:fmagic'] = "UNIT_AURA"

-- Monk
-- Monk
oUF.Tags.Methods['q:zs'] = function(u) if UnitAura(u, GetSpellInfo(124081)) then return "|cff97FFFF"..x.."|r" end end -- —фера ƒзен
oUF.Tags.Events['q:zs'] = "UNIT_AURA"

oUF.Tags.Methods['q:remist'] = function(u) -- «аживл€ющий туман
