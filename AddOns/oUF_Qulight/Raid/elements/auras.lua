...
local CreateAuraIcon = function(auras)
    ...
    count:SetFont(Qulight["media"].pxfont, Qulight["raidframes"].fontsizeEdge, Qulight["raidframes"].outline)
    ...
    remaining:SetPoint("CENTER", 2, 1) 
    remaining:SetFont(Qulight["media"].pxfont, Qulight["raidframes"].fontsizeEdge, Qulight["raidframes"].outline)
...
local dispelClass = {
	...
	SHAMAN = { Curse = true, Magic = false, }, --Purify Spirit
	PALADIN = { Poison = true, Disease = true, Magic = false, }, --Cleanse
	MAGE = { Curse = true, }, --Remove Curse
	DRUID = { Curse = true, Poison = true, Magic = false, }, --Nature's Cure
	MONK = { Poison = true, Disease = true, Magic = false, }, --Detox
}
...
local function CheckSpec()
	...
	if (class == "SHAMAN" or class == "PALADIN" or class == "DRUID" or class == "DRUID") then
    	if CheckRole() == "Healer" then
			dispelClass[class].Magic = true
		else
			dispelClass[class].Magic = false	
		end
	end
end
