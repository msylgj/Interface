...
local function macroBody(class)
    ...
    if combatspell then
        body = body .. "/cast [combat,help,dead,@mouseover,mod:alt] " .. combatspell .. "; "

        if oocspell then
            body = body .. "[help,dead,@mouseover,mod:alt] " .. oocspell .. "; "
        end
    ...
    elseif oocspell then
        body = body .. "/cast [help,dead,@mouseover,mod:alt] " .. oocspell .. "; "
    end
...
local Enable = function(self)
    ...
    if not class or not Qulight["raidframes"].autorez then return end
...
local Disable = function(self)
    if Qulight["raidframes"].autorez then return end
