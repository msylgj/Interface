...
local Enable = function(self)
	if self.freebHeals then
		...
		self.myHealPredictionBar:SetStatusBarColor(Qulight["raidframes"].myhealcolor.r, Qulight["raidframes"].myhealcolor.g, Qulight["raidframes"].myhealcolor.b, Qulight["raidframes"].myhealcolor.a)
		...
		self.otherHealPredictionBar:SetStatusBarColor(Qulight["raidframes"].otherhealcolor.r, Qulight["raidframes"].otherhealcolor.g, Qulight["raidframes"].otherhealcolor.b, Qulight["raidframes"].otherhealcolor.a)
