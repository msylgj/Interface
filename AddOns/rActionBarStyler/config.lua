  ...
  cfg.bars = {
    ...
    bar1 = {
      ...
      pos             = { a1 = "BOTTOM", a2 = "BOTTOM", af = "UIParent", x = -1, y = 17 }, 
      userplaced      = {
        enable          = false,
      },
      mouseover       = {
    ...
    overridebar = { --the new vehicle and override bar
      ...
      pos             = { a1 = "BOTTOM", a2 = "BOTTOM", af = "UIParent", x = -169, y = 86 }, 
      userplaced      = {
        enable          = false,
      },
      mouseover       = {
    ...
    bar2 = {
      ...
      pos             = { a1 = "BOTTOM", a2 = "BOTTOM", af = "UIParent", x = -1, y = 47.5 }, 
      userplaced      = {
        enable          = false,
      },
      mouseover       = {
    ...
    bar3 = {
      ...
      pos             = { a1 = "BOTTOM", a2 = "BOTTOM", af = "UIParent", x = -1, y = 19 },
      userplaced      = {
        enable          = false,
      },
      mouseover       = {
    ...
    bar4 = {
      ...
      pos             = { a1 = "RIGHT", a2 = "RIGHT", af = "UIParent", x = -2, y = 0 },
      userplaced      = {
        enable          = false,
      },
      mouseover       = {
    ...
    bar5 = {
      ...
      pos             = { a1 = "RIGHT", a2 = "RIGHT", af = "UIParent", x = -33, y = 0 }, 
      userplaced      = {
        enable          = false,
      },
      mouseover       = {
    ...
    petbar = {
      ...
      pos             = { a1 = "BOTTOM", a2 = "BOTTOM", af = "UIParent", x = 168, y = 86 },
      userplaced      = {
        enable          = false,
      },
      mouseover       = {
    ...
    extrabar = {
      ...
      pos             = { a1 = "BOTTOMRIGHT", a2 = "BOTTOMRIGHT", af = "UIParent", x = -5, y = 205 },
      userplaced      = {
        enable          = false,
      },
      mouseover       = {
    ...
    leave_vehicle = {
      ...
      pos             = { a1 = "BOTTOM", a2 = "BOTTOM", af = "UIParent", x = -300, y = 10 }, 
      userplaced      = {
        enable          = false,
      },
      mouseover       = {
